...
public class PedidosController : ControllerBase
{
    ...
    {
        var pedido = await _mediator.Send(new AddItemCommand(id, request.ProdutoId, request.NomeProduto, request.PrecoCentavos));
        return Ok(pedido);
    }
    ...
    public record AddItemRequest(Guid ProdutoId, string NomeProduto, int PrecoCentavos);
