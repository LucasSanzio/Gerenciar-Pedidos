...
public class PedidoItem
{
    ...
    /// <summary>
    /// Identificador do setor do produto no momento da venda.
    /// </summary>
    public Guid SetorId { get; private set; }

    /// <summary>
    /// Nome do setor do produto no momento da venda.
    /// </summary>
    ...
    public PedidoItem(Guid produtoId, Guid setorId, string setorNome, string nomeProduto, int precoCentavos)
        : this()
    {
        ...
        {
            throw new ArgumentException("O identificador do setor é obrigatório.", nameof(setorId));
        }

        if (string.IsNullOrWhiteSpace(setorNome))
        {
            throw new ArgumentException("O nome do setor é obrigatório.", nameof(setorNome));
        }
